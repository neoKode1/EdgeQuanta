"""
Ion trap quantum system protocol adapter (离子阱通信协议)
"""
import json
import time
...
class IonTrapAdapter:
    """Adapter for ion trap quantum system protocol"""
    ...
    def parse_task_message(msg: str) -> Dict[str, Any]:
        """Parse task message with flat structure"""
        data = json.loads(msg)
